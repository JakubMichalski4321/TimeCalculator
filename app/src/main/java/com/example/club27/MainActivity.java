...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button obliczButton = (Button) findViewById(R.id.obliczButton);
        ...
        final Switch byloPiteSwitch = (Switch) findViewById(R.id.byloPiteSwitch);
        final EditText minutesSetEditText = (EditText) findViewById(R.id.minutesSetEditText);
